...
export function Button({ variant = 'primary', children, className = '', ...props }: ButtonProps) {
  ...
  const variants = {
    ...
    tertiary: "bg-transparent text-white/90 border border-white/20 py-3 px-6 hover:bg-gold hover:text-primary-dark hover:border-gold rounded-[4px]",
    icon: "w-10 h-10 rounded-full bg-transparent text-white/90 hover:bg-gold/10 hover:text-gold hover:scale-110 flex items-center justify-center transition-all duration-300"
  };
